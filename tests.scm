...
(define (square x) (* x x))
; LambdaProcedure
; self.formals = Pair(x, nil)
; self.body = Pair(*, Pair(x, Pair(x, nil)))
; global environmenet define(square, LambdaProcedure)
...
;Pair(define, Pair(Pair(f, Pair(x, nil)), Pair(Pair(*, Pair(x, Pair(2, nil))), nil)))
;first - define
; second - Pair(Pair(f, Pair(x, nil)), Pair(Pair(*, Pair(x, Pair(2, nil))), nil))
;first - Pair(f, Pair(x, nil))
;second - Pair(Pair(*, Pair(x, Pair(2, nil))), nil)
; define(first[0], do_lambda_form(Pair(first[1], second), env)
...
(begin (+ 2 3) (+ 5 6))
; Pair(begin, Pair(Pair(+ Pair(2, Pair(3, nil))), Pair(Pair(+, Pair(5, Pair(6, nil))), nil))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; verify problems 3 and 4 were completed correctly
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; verify problem A5 runs correctly
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; verify problem B6 runs correctly
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; verify problem 7 runs correctly
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; verify problem 8 runs correctly
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
